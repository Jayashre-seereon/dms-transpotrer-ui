...
// ---------------- Data ----------------
const summary = [
  { label: "Total Assignments", value: 150, icon: <DollarOutlined className="text-amber-600!" /> },
  { label: "Pending Assignments", value: 124, icon: <ClockCircleOutlined className="text-yellow-600!" /> },
  { label: "In Transit Deliveries", value: 121, icon: <TruckOutlined className="text-blue-600!" /> },
  { label: "Delivered Orders", value: 123, icon: <CalendarOutlined className="text-green-600!" /> },
];
