...
const poJSON = {
  ...
  statusOptions: ["Pending", "Assigned", "Approved", "In Transit", "Out for Delivery", "Delivered"],
};
...
export default function PurchaseOrderList() {
  ...
  const handleFormSubmit = (values, isAssign) => {
    ...
    const actualQty = parseFloat(fields.actualQty) || 0;
    const requiredQty = parseFloat(currentRecord.requiredQty) || 0;
    const calculatedVariance = actualQty - requiredQty;
  ...
  const currentStatus = selectedRecord?.status;
    ...
    return (
      <>
       <div className="text-base! font-semibold! m-0! text-amber-600!">
  Purchase Order Details
</div>
 <Row gutter={24}>
          <Col span={6}><Form.Item label="Order No" name="orderNo"><Input disabled /></Form.Item></Col>
          <Col span={6}>
          ...
          <Col span={6}>
              <Form.Item label="Est. Delivery Date" name="estimateDeliveryDate" rules={[{ required: true, message: 'Required' }]}>
                <DatePicker format="DD-MM-YYYY" className="w-full" disabled={isPoDetailDisabled} />
                   ...
                   <Col span={6}><Form.Item label="Way Bill" name="wayBill" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
      
           <Col span={6}>
            <Form.Item label="Status" name="status" rules={[{ required: true, message: 'Required' }]}>
              <Select 
                disabled={!isStatusEditable} 
                options={statusOptionsToDisplay}
              />
            </Form.Item>
          </Col>
        </Row>
...
Vendor Detail</div>
        <Row gutter={24}>
          <Col span={6}><Form.Item label="Vendor Name" name="vendorName" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Address" name="vendorAddress" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="GSTIN" name="vendorGSTIN" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Contact Person Name" name="vendorContactPerson" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Phone Number " name="vendorPhoneNumber" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
        </Row>

         <div className="text-base! font-semibold! m-0! text-amber-600!">
Plant Detail</div>
        <Row gutter={24}>
          <Col span={6}><Form.Item label="Plant Name" name="plantName" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Plant Code" name="plantCode" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="GSTIN" name="plantGSTIN" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Address" name="plantAddress" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Contact Person" name="plantContactPerson" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Phone Number" name="plantPhoneNumber" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
        </Row>

        <div className="text-base! font-semibold! m-0! text-amber-600!">
Product Details</div>
        <Row gutter={24}>
          <Col span={6}><Form.Item label="Product ID" name="productId" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Product Name" name="productName" rules={[{ required: true, message: 'Required' }]}><Input disabled={isPoDetailDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Required Qty" name="requiredQty" rules={[{ required: true, message: 'Required' }]}><Input type="number" disabled={true} /></Form.Item></Col>
          <Col span={6}><Form.Item label="UOM" name="uom" rules={[{ required: true, message: 'Required' }]}><Input disabled={isUOMDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Actual Qty" name="actualQty" rules={[{ required: true, message: 'Required' }]}><Input type="number" disabled={isProductQtyDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Variance" name="variance"><Input type="number" disabled /></Form.Item></Col>
        </Row>
      </>
    );
  };
...
Transport Detail</div>
        <Row gutter={24}>
          <Col span={6}><Form.Item label="Vehicle No." name="vehicleNo" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Driver Name" name="driverName" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Driver Contact" name="driverContact" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Insurance Valid Upto" name="insuranceValidUpto" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}>
            <DatePicker format="DD-MM-YYYY" className="w-full" disabled={isTransportLoadingDisabled} />
          </Form.Item></Col>
          <Col span={6}><Form.Item label="PU Valid Upto" name="puValidUpto" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}>
            <DatePicker format="DD-MM-YYYY" className="w-full" disabled={isTransportLoadingDisabled} />
          </Form.Item></Col>
          <Col span={6}><Form.Item label="Fitness Valid Upto" name="fitnessValidUpto" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}>
            <DatePicker format="DD-MM-YYYY" className="w-full" disabled={isTransportLoadingDisabled} />
          </Form.Item></Col>
        </Row>
...
Loading Details</div>
        <Row gutter={24}>
          <Col span={6}><Form.Item label="Vehicle In Time" name="vehicleInTime" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Vehicle Out Time" name="vehicleOutTime" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Tare Weights (KGs)" name="tareWeights" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input type="number" disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Net Weight (KGs)" name="netWeight" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input type="number" disabled={isTransportLoadingDisabled} /></Form.Item></Col>
          <Col span={6}><Form.Item label="Gross Weights (KGs)" name="grossWeights" rules={[{ required: !isTransportLoadingDisabled, message: 'Required' }]}><Input type="number" disabled={isTransportLoadingDisabled} /></Form.Item></Col>
        </Row>
      </>
    );
   };
   ...
   <div> <h1 className="text-3xl font-bold text-amber-700">Purchase Orders </h1>
          <p className="text-amber-600">Manage your pending and approved purchase requests.</p>
       </div>
   ...
   <div className="flex gap-2">
    ...
    >
      ...
      <Modal
        title={<span className="text-amber-700 font-semibold">Edit Purchase Order</span>}
      ...
      >
        <Form
          layout="vertical"
          form={editForm}
          onFinish={() => editForm.validateFields().then(() => handleFormSubmit(null, false))}
        >
        <div>
  {selectedRecord?.status !== "Pending" && (
      <>{renderTransportAndLoading(false, true)}</>
  )}
  {renderAllDetails(false, true)}
      ...
      <Modal
        title={<span className="text-amber-700 font-semibold">Assign Transport </span>}
      ...
      >
        <Form
          layout="vertical"
          form={assignForm}
          onFinish={() => assignForm.validateFields().then(() => handleFormSubmit(null, true))}
        >
         <div>
  ...
  {renderAllDetails(true, false)}
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <Button type="primary" htmlType="submit" className="bg-amber-500 hover:bg-amber-600 border-none">Assign PO</Button>
          </div>
        </Form>
      </Modal>
      ...
      {/* --- View Modal --- */}
      <Modal
        title={<span className="text-amber-700 text-2xl font-semibold">View Purchase Order</span>}
  ...
  <div>
  {selectedRecord?.status !== "Pending" && (
      <>{renderTransportAndLoading(true, false)}</>
  )}
  {renderAllDetails(true, false)}
  </div>
